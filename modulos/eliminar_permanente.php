...
if(isset($_POST['checkboxes'])) {
    ...
    foreach ($checkboxes as $checkbox){
        ...
        if($result->num_rows!=0){
            ...
            $sql="delete from modulos_funcionalidades where id_$nomeColuna='$id'";
            $result=runQ($sql,$db,"ELIMINAR VARIOS2");

            $sql="delete from grupos_modulos_funcionalidades where id_$nomeColuna='$id'";
            $result=runQ($sql,$db,"ELIMINAR VARIOS3");
