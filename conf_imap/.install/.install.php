...
if(isset($_GET['instalar'])){
    ...
    $db=ligarBD();
    $sql="insert into modulos (nome_modulo,url,icon,nomeTabela,nomeColuna,id_parent,descricao,mostrar,principal,id_criou,created_at) values ('IMAP','conf_imap','fa-gear','_conf_imap','conf','20','','1','0','1','2022-04-30 23:52:02')";
