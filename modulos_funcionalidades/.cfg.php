...
$subModulo=1;
$tabelaParent="modulos";
$colunaParent="modulo";
//dados do módulo na BD

$nomeTabela="modulos_funcionalidades";
$nomeColuna="funcionalidade";
$innerjoin="";
...
$colunasParaMostrarNaTabela=[
    ...
    "icon" => "class::text-center hidden-xs|text::|value::<i class='fa _icon_'></i>",
    "nome_$nomeColuna" => "link|text::Nome",
    "ordem" => "link|text::Ordem",
...
$ordenarPorDefeito="$nomeTabela.id_$nomeColuna";
$opcoesOrdenar=[
