...
if(isset($_GET['instalar'])){
    ...
    $db=ligarBD();
    $sql="insert into modulos (nome_modulo,url,icon,nomeTabela,nomeColuna,id_parent,descricao,mostrar,principal,id_criou,created_at) values ('Peças','mod_pecas','fa-wrench','pecas','peca','0','','1','0','1','2022-08-23 15:37:51')";
