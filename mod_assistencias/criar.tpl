  ...
  <div class="form-group form-group-sm">
            <div class="col-xs-12" style="padding-top: 0px">
                ...
                <div class="form-group form-group-sm ">
                    <div class="col-xs-12" style="padding-top: 0px">
                        ...
                        <div class="col-lg-12 input-status">
                            <label class='csscheckbox csscheckbox-primary'><input type='radio' name='id_categoria' checked value='0'><span></span> Sem categoria</label><br>
                            _id_categoria_
                        </div>
                    </div>
                </div>
        ...
        <div class="form-group form-group-sm">
            <div class="col-xs-12">
                ...
                <div class="col-lg-12">
                     <textarea id="descricao" rows="5" name="descricao" class="form-control"></textarea>
                </div>
            </div>
        </div>
