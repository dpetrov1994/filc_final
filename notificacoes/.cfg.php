...
$nomeTabela="notificacoes";
$nomeColuna="notificacao";
$innerjoin=" 
inner join utilizadores_notificacoes on utilizadores_notificacoes.id_notificacao=notificacoes.id_notificacao
";

$add_sql.=" and utilizadores_notificacoes.id_utilizador='".$_SESSION['id_utilizador']."'";
...
$colunasParaMostrarNaTabela=[
    ...
    "nome_notificacao" => "text::Notificação|link::_url_",

    "visto_em" => "text::Estado",
    ///////////////////////////////////////////////
