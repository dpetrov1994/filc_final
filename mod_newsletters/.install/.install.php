...
if(isset($_GET['instalar'])){
    ...
    $db=ligarBD();
    $sql="insert into modulos (nome_modulo,url,icon,nomeTabela,nomeColuna,id_parent,descricao,mostrar,principal,id_criou,created_at) values ('Newsletters','mod_newsletters','fa-newspaper-o','newsletters','newsletter','0','','1','0','1','2021-12-22 13:48:52')";
