...
if(isset($_GET['instalar'])){
    ...
    $db=ligarBD();
    $sql="insert into modulos (nome_modulo,url,icon,nomeTabela,nomeColuna,id_parent,descricao,mostrar,principal,id_criou,created_at) values ('Assistências e Clientes','mod_assistencias_clientes','fa-users','assistencias_clientes','id_assistencia_cliente','292','','1','0','1','2022-08-17 16:52:50')";
