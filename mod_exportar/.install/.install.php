...
if(isset($_GET['instalar'])){
    ...
    $db=ligarBD();
    $sql="insert into modulos (nome_modulo,url,icon,nomeTabela,nomeColuna,id_parent,descricao,mostrar,principal,id_criou,created_at) values ('Exportar/Importar','mod_exportar','fa-arrow-circle-o-down','exportacoes','exportacao','187','','1','0','1','2018-07-06 14:23:32')";
