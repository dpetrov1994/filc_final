...
if(isset($_GET['instalar'])){
    ...
    $db=ligarBD();
    $sql="insert into modulos (nome_modulo,url,icon,nomeTabela,nomeColuna,id_parent,descricao,mostrar,principal,id_criou,created_at) values ('Documentos de Identificação','sup_documentos_identificacao','fa-id-card','sup_documentos_identificacao','documento_identificacao','0','','1','0','1','2018-04-18 10:31:24')";
