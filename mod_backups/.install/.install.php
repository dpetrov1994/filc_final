...
if(isset($_GET['instalar'])){
    ...
    $db=ligarBD();
    $sql="insert into modulos (nome_modulo,url,icon,nomeTabela,nomeColuna,id_parent,descricao,mostrar,principal,id_criou,created_at) values ('Backups','mod_backups','fa-download','backups','backup','0','','1','0','1','2018-05-24 08:29:50')";
