...
if(isset($_GET['instalar'])){
    ...
    $db=ligarBD();
    $sql="insert into modulos (nome_modulo,url,icon,nomeTabela,nomeColuna,id_parent,descricao,mostrar,principal,id_criou,created_at) values ('Tipos de Serviços','mod_tipos_servicos','fa-wrench','tipos_servicos','tipo_servico','187','','1','0','1','2022-09-28 12:29:45')";
