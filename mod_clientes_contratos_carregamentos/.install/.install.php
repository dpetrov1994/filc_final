...
if(isset($_GET['instalar'])){
    ...
    $db=ligarBD();
    $sql="insert into modulos (nome_modulo,url,icon,nomeTabela,nomeColuna,id_parent,descricao,mostrar,principal,id_criou,created_at) values ('Carregamentos','mod_clientes_contratos_carregamentos','fa-clock-o','clientes_contratos_carregamentos','carregamento','284','','1','0','21','2022-08-13 22:14:48')";
