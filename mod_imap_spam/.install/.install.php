...
if(isset($_GET['instalar'])){
    ...
    $db=ligarBD();
    $sql="insert into modulos (nome_modulo,url,icon,nomeTabela,nomeColuna,id_parent,descricao,mostrar,principal,id_criou,created_at) values ('Emails SPAM','mod_imap_spam','fa-cogs','imap_spam','spam','187','','1','0','1','2022-05-29 21:37:56')";
