...
$colunasParaMostrarNaTabela=[
    "nome_pasta" => "link::index.php?id=_id_pasta_|text::|value::<i class='fa fa-folder fa-5x text-warning'></i>|style::width:60px",
    "nomePasta" => "link::index.php?id=_id_pasta_|text::|",
    "descricao" => "cortaStr::200|class::hidden-xs|text::",
