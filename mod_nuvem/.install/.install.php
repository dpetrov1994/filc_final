...
if(isset($_GET['instalar'])){
    ...
    $db=ligarBD();
    $sql="insert into modulos (nome_modulo,url,icon,nomeTabela,nomeColuna,id_parent,descricao,mostrar,principal,id_criou,created_at) values ('Núvem Privada','mod_nuvem','fa-folder','pastas','pasta','0','','1','0','1','2018-04-10 19:21:29')";
...
($id_modulo,'1','fa-times','Eliminar permanente','','Elimina permanentemente o registo.','eliminar_permanente.php','0','0','1','1','1','0','".$_SESSION['id_utilizador']."','".current_timestamp."','0')",
    ...
    $sql=file_get_contents(".tabela2.sql");
