...
if(isset($_GET['instalar'])){
    ...
    $db=ligarBD();
    $sql="insert into modulos (nome_modulo,url,icon,nomeTabela,nomeColuna,id_parent,descricao,mostrar,principal,id_criou,created_at) values ('Relatórios Comerciais','mod_relatorios_comerciais','fa-pencil','relatorios_comerciais','ralatorio','0','','1','0','1','2022-11-03 22:54:23')";
