...
if(isset($_GET['instalar'])){
    ...
    $db=ligarBD();
    $sql="insert into modulos (nome_modulo,url,icon,nomeTabela,nomeColuna,id_parent,descricao,mostrar,principal,id_criou,created_at) values ('Perfis de desempenho','mod_perfis','fa-asterisk','mod_perfis','perfil','0','','1','0','1','2021-01-28 16:30:09')";
