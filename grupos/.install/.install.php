...
if(isset($_GET['instalar'])){
    ...
    $db=ligarBD();
    $sql="insert into modulos (nome_modulo,url,icon,nomeTabela,nomeColuna,id_parent,descricao,mostrar,principal,id_criou,created_at) values ('Grupos','grupos','fa-users','grupos_new','grupo','19','Gestão de permissões atribuídas a cada grupo de utilizadores.','1','0','1','2018-03-23 14:31:08')";
