...
if(isset($_GET['instalar'])){
    ...
    $db=ligarBD();
    $sql="insert into modulos (nome_modulo,url,icon,nomeTabela,nomeColuna,id_parent,descricao,mostrar,principal,id_criou,created_at) values ('Relatórios satisfação','mod_satisfacao','fa-star','assistencias_clientes_satisfacao','satisfacao','293','','1','0','1','2022-10-24 16:38:45')";
