...
$itensObrigatorios = [ //intes que são obrigatórios
    'id_assistencia_cliente','id_utilizador','id_cliente',
];
...
$colunasParaMostrarNaTabela=[
    ...
    "created_at" => "date::%d/%m/%Y %H:%M|text::Data",
    "nome_cliente" => "text::Cliente",
    "nome_utilizador" => "text::Técnico",
    "nome_assistencia" => "text::Assistencia",
    "classificacao" => "text::Classificacao|if::
                1=><i class='fa fa-star text-danger'></i>,,
                2=><i class='fa fa-star text-danger'></i><i class='fa fa-star text-danger'></i>,,
                3=><i class='fa fa-star text-danger'></i><i class='fa fa-star text-danger'></i><i class='fa fa-star text-danger'></i>,,
                ...
                5=><i class='fa fa-star text-success'></i><i class='fa fa-star text-success'></i><i class='fa fa-star text-success'></i><i class='fa fa-star text-success'></i><i class='fa fa-star text-success'></i>
                ",
