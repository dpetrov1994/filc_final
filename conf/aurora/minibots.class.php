...
3.83 fixed getImageGoogle 06/11/2019
3.82 new getLatLongBis with locationiq.com free api, fixed doSpelling 03/11/2019
3.81 migliorate reg exp GetInstagramPic
3.80 added auth key to getlatlong
3.79 fixed geoCode method 04/01/2019
3.78 fixed ipToGeo, fixed readFacebookPageCounters, fixed doSpelling 04/01/2019
3.77 added youtube view count in getVideoUrlInfo method 03/01/2019
3.76 fixed problem with encoding in googleSuggestKeywords method 05/11/2018
3.75 removed NotifyMyAndroid, addedd notifyMyDevice 06/08/2018
3.74 updated getInstagramFollowers 03/04/2018
3.73 updated instagram methods 15/03/2018 cambiato user
	...
	*/
	public function getPage($url, $max_file_size=0) {
		...
		*/
		...
		curl_setopt($ch, CURLOPT_USERAGENT, "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/76.0.3809.132 Safari/537.36");   // Webbot name
