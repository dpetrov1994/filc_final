...
if(isset($_GET['instalar'])){
    ...
    $db=ligarBD();
    $sql="insert into modulos (nome_modulo,url,icon,nomeTabela,nomeColuna,id_parent,descricao,mostrar,principal,id_criou,created_at) values ('Calendário','mod_calendario','fa-calendar','calendario','calendario','0','','0','0','1','2020-11-26 13:25:11')";
