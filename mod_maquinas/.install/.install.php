...
if(isset($_GET['instalar'])){
    ...
    $db=ligarBD();
    $sql="insert into modulos (nome_modulo,url,icon,nomeTabela,nomeColuna,id_parent,descricao,mostrar,principal,id_criou,created_at) values ('Máquinas','mod_maquinas','fa-gear','maquinas','maquina','0','','1','0','1','2022-08-17 14:44:15')";
