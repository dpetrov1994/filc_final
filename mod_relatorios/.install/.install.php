...
if(isset($_GET['instalar'])){
    ...
    $db=ligarBD();
    $sql="insert into modulos (nome_modulo,url,icon,nomeTabela,nomeColuna,id_parent,descricao,mostrar,principal,id_criou,created_at) values ('Relatórios','mod_relatorios','fa-file-text-o','relatorios','relatorio','0','','1','0','1','2021-08-04 22:23:01')";
