...
$nomeTabela="relatorios";
$nomeColuna="relatorio";
$innerjoin="";
$add_sql.="";
...
$colunasParaMostrarNaTabela=[
    ...
    "categoria" => "link|text::Categoria",
    "descricaoP" => "class::hidden-xs|text::Obs.|value::
<a href=\"javascript:void(0)\" class='btn btn-xs btn-_corObs_' data-toggle=\"popover\" data-placement='left' data-trigger=\"click\" title=\"Observações\" data-content=\"_descricaoP_\">Obs.</a>
",
...
$opcoesOrdenar=[
    "$nomeTabela.id_$nomeColuna asc"=>"ID ASC",
