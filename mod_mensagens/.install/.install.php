...
if(isset($_GET['instalar'])){
    ...
    $db=ligarBD();
    $sql="insert into modulos (nome_modulo,url,icon,nomeTabela,nomeColuna,id_parent,descricao,mostrar,principal,id_criou,created_at) values ('Mensagens','mod_mensagens','fa-envelope','mensagens','mensagem','0','','1','0','1','2018-03-26 18:00:26')";
