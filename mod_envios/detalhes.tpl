        ...
        <div class="block">
                ...
                <div class="form-group">
                    <div class="col-md-4 col-xs-6">
                        <div class="col-lg-6">
                            ...
                            <br><a href="../logs/index.php?&id_item=_idItem_&nome_tabela=envios" target="_blank"><i class="fa fa-history"></i> Histórico (_cntRevisoes_)</a>
            ...
            <div class="form-group form-group-sm">
                <div class="col-xs-12">
                    ...
                    <div class="col-lg-12 input-status">
                        <input id="nome_envio" name="nome_envio" maxlength="250"  class="form-control" placeholder=""  type="text">
                    </div>
                </div>
            </div>
