...
if(isset($_GET['instalar'])){
    ...
    $db=ligarBD();
    $sql="insert into modulos (nome_modulo,url,icon,nomeTabela,nomeColuna,id_parent,descricao,mostrar,principal,id_criou,created_at) values ('orcamentos','mod_orcamentos','fa-files-o','orcamentos','orcamento','0','','1','0','1','2021-02-24 16:29:49')";
