...
$nomeTabela="orcamentos";
$nomeColuna="orcamento";
$innerjoin="";
$add_sql.="";
...
$colunasParaMostrarNaTabela=[
    "checkbox" => "checkbox",
    "ref" => "link|text::#|class::text-center",
    'criador' => "text::Criado por",
    "OrganizationName" => "text::Cliente",
    "orc_created_at" => "date::%d/%m/%Y|text::Criado",
    "totalComIva" => "class::text-right|text::Total",
    "fechado" => "text::Estado|if::1=><span class='label label-success'>Fechado</span>,,0=><span class='label label-warning'>Aberto</span>",
...
$opcoesOrdenar=[
    ...
    "$nomeTabela.descricao asc"=>"Observaciones ASC",
    "$nomeTabela.descricao desc"=>"Observaciones DESC"
];
...
if(isset($fechado) && $fechado==1){
    $add_sql.=" and $nomeTabela.fechado=1";
}elseif ($ativo=1){
    $add_sql.=" and $nomeTabela.fechado=0";
}
