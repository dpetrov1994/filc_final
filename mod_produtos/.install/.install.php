...
if(isset($_GET['instalar'])){
    ...
    $db=ligarBD();
    $sql="insert into modulos (nome_modulo,url,icon,nomeTabela,nomeColuna,id_parent,descricao,mostrar,principal,id_criou,created_at) values ('Produtos','mod_produtos','fa-circle','produtos','produto','0','','0','0','1','2021-02-24 16:15:34')";
