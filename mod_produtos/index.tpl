        ...
        <div class="block">
            <div class="block-section row">
                    ...
                    <div class="form-group col-xs-6 col-lg-3">
                        Familia
                        <select onchange="document.getElementById('form-pagina').submit()" id="familia" name="familia"  class="select-select2 input-sm" style="width: 100%;">
                    ...
                    <div class="form-group col-xs-12 col-lg-5">
                        <span class="hidden-xs">Busca</span>
                        <div class="input-group input-group-sm">
                            <input id="example-input2-group2" value="_p_" name="p" class="form-control" placeholder="Buscar.." type="text">
                            <span class="input-group-btn">
                            <button type="submit" class="btn btn-effect-ripple btn-primary" style="overflow: hidden; position: relative;"><i class="fa fa-search"></i> <span class="hidden-xs">Buscar</span></button>
                        </span>
                        </div>
                    </div>
