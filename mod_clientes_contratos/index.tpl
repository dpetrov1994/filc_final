            ...
            <div class="block-section row">
                ...
                <form id="form-pagina" action="_formAction__addUrl_" method="get">
                    ...
                    <div class="form-group col-xs-6 col-lg-4 ">
                        Cliente
                        <select onchange="document.getElementById('form-pagina').submit()" id="id_cliente" name="id_cliente"  class="select-select2 input-sm" style="width: 100%;" data-placeholder="Selecione..">
                            <option></option><!-- Required for data-placeholder attribute to work with Select2 plugin -->
                            _id_cliente_
                        </select>
                    </div>
