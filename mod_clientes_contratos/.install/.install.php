...
if(isset($_GET['instalar'])){
    ...
    $db=ligarBD();
    $sql="insert into modulos (nome_modulo,url,icon,nomeTabela,nomeColuna,id_parent,descricao,mostrar,principal,id_criou,created_at) values ('Contratos','mod_clientes_contratos','fa-file-text-o','clientes_contratos','contrato','284','','1','0','1','2022-03-28 23:00:19')";
