...
$nomeTabela="clientes_contratos";
$nomeColuna="contrato";
$innerjoin=" inner join srv_clientes using(id_cliente)";
$add_sql.="";

$itensIgnorar = [ // são os itens que vêm do POST que não sao para inserir na BD
    'submit','data_inicio','data_inicio', 'form-ajax','include_from_other_file',
];
...
$colunasParaMostrarNaTabela=[
    "checkbox" => "checkbox",
    "nome_$nomeColuna" => "link|text::Nome do contrato|value::_nome_contrato_<br><small><i class='fa fa-clock-o'></i> _segundos_restantes_</small><br>_descricao_",
    "OrganizationName" => "text::Cliente|value::_OrganizationName_",
