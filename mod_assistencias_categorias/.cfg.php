...
$nomeTabela="assistencias_categorias";
...
$colunasParaMostrarNaTabela=[
    ...
    "nome_$nomeColuna" => "link|text::Nome|value::<span class='label' style='background: _cor_cat_'>_nome_categoria_</span>",
    "descricao" => "cortaStr::200|class::hidden-xs|text::Observações",
    "comercial" => "text::Visibilidade|if::1=><span class='label label-success'>Comerciais</span>,,0=><span class='label label-info'>Tecnicos</span>",
    ///////////////////////////////////////////////
