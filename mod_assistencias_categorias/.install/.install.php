...
if(isset($_GET['instalar'])){
    ...
    $db=ligarBD();
    $sql="insert into modulos (nome_modulo,url,icon,nomeTabela,nomeColuna,id_parent,descricao,mostrar,principal,id_criou,created_at) values ('Categorias de Serviços','mod_assistencias_categorias','fa-check','assistencias_categorias','categoria','292','','0','0','1','2022-10-01 18:36:21')";
