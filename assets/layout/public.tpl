...
<head onclick="">
    ...
    <title>_nomePagina_ - _nomePlataforma_</title>
    ...
    <link rel="stylesheet" href="_layoutDirectory_/css/animate.css">
    ...
    <link rel="stylesheet" id="theme-css"  href="_layoutDirectory_/css/themes/_temaPlataforma_">
    <!-- END Stylesheets -->
...
<img src="_layoutDirectory_/img/login.png" alt="Full Background" class="full-bg">
<!-- END Full Background -->

<!-- Login Container -->
<div id="public-container">
    <!-- Login Header -->
    <h3 class="h2 text-light text-center animation-pullDown">
        <a href="index.php" class="text-light-op">
            <img class="" src="_layoutDirectory_/img/icon80.png" >
            <strong class="" >_nomePlataforma_</strong>
        </a>
    </h3>
    <!-- END Login Header -->
...
<!-- END Login Container
<a href="#modal-compose" class="hidden" data-toggle="modal" id="gatoModal"></a>
<div id="modal-compose" class="modal fade" role="dialog" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                <h3 class="modal-title"><i class="fa fa-star text-warning"></i> <strong>Parabéns encontrou um segredo!</strong> <i class="fa fa-star text-warning"></i></h3>
            </div>
            <div class="modal-header">
                ...
                <h4>Existem mais escondidos pela plataforma... continue a procura.</h4>
...
<script src="_layoutDirectory_/js/login.js"></script>
