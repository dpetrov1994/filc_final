...
<head>
    ...
    <style type="text/css">
        @media only screen and (max-width: 550px), screen and (max-device-width: 550px) {
            ...
            body[yahoo] .button a { background-color: rgba(147, 147, 140, 0.72); padding: 15px 25px !important; }
        }
...
<table align="center" border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse; width: 100%; max-width: 600px;" class="content">
    ...
    <tr>
        <td align="justify" bgcolor="#ffffff" style="padding: 10px; color: #555555; font-family: Arial, sans-serif; font-size: 12px; line-height: 18px;">
            <p>_conteudo_</p>
        </td>
    </tr>
    <tr>
        <td align="center" bgcolor="#e9e9e9" style="padding: 12px 10px 12px 10px; color: #888888; font-family: Arial, sans-serif; font-size: 12px; line-height: 18px;">
            <b><a href="_siteEmpresa_" style="color: #505050;">_nomeEmpresa_</a></b> | _moradaEmpresa_
        </td>
    </tr>
    <tr>
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                <tr>
                    <td align="center" width="100%" style="color: #999999; font-family: Arial, sans-serif; font-size: 12px;">
                        _copyAno_ &copy; <a href="_copySite_" style="color: #505050;">_copyPlataforma_</a>
                    </td>
                </tr>
            </table>
        </td>
