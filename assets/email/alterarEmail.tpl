...
<tr>
    <td align="center" bgcolor="#ffffff" style="padding: 0 20px 40px 20px; color: #777777; font-family: Arial, sans-serif; font-size: 18px; line-height: 30px; border-bottom: 1px solid #f6f6f6;">
        O seu pedido de alteração de email foi iniciado.<br>
        <b>Novo Email:</b> _email_<br>
        <b>Senha:</b> _pass_<br>
        Por motivos de segurança, se a sua senha estiver visível, aconselhamos que altere após iniciar sessão.<br>
        <br>
        Clique no botão abaixo para verificar o novo Email.<br>
        ou<br>
        Copie e cole o endreço na barra de endreços do seu browser.<br>
        <a href="_recoveryURL_" >_recoveryURL_</a>
    </td>
</tr>
<tr>
    <td align="center" bgcolor="#f9f9f9" style="padding: 30px 20px 30px 20px; font-family: Arial, sans-serif;">
        <table bgcolor="#5ccdde" border="0" cellspacing="0" cellpadding="0" class="buttonwrapper">
            <tr>
                <td align="center" height="55" style=" padding: 0 35px 0 35px; font-family: Arial, sans-serif; font-size: 22px;" class="button">
                    <a href="_recoveryURL_" style="color: #ffffff; text-align: center; text-decoration: none;">Continuar</a>
                </td>
            </tr>
        </table>
    </td>
...
<tr>
    <td align="center" bgcolor="#ffffff" style="padding: 20px 20px 20px 20px; color: #555555; font-family: Arial, sans-serif; font-size: 15px; line-height: 24px;">
        Ajude-me! <a href="#" style="color: #5ccdde;">Não sei porquê que recebi esta mensagem..</a>
    </td>
</tr>