...
echo "Get Facebook counters for <b>https://www.dailybest.it/society/vita-programmatore-gif-animate/</b><br>";
echo "<pre>".print_r($mb->readFacebookCounters("https://www.dailybest.it/society/vita-programmatore-gif-animate/"),true)."</pre>";
echo "<hr>";

// test readFacebookCounter
// -------------------------------------------------------------
echo "<h2>readTwitterCounter method</h2>";
echo "Get number of times the url <b>https://www.dailybest.it/society/vita-programmatore-gif-animate/</b> has been twitted<br>";
echo "<pre>".print_r($mb->readTwitterCounter("https://www.dailybest.it/society/vita-programmatore-gif-animate/"),true)."</pre>";
echo "<hr>";
...
echo "Get number of times the url <b>https://www.dailybest.it/society/vita-programmatore-gif-animate/</b> has been twitted<br>";
echo "<pre>".print_r($mb->readGooglePlusCounter("https://www.dailybest.it/society/vita-programmatore-gif-animate/"),true)."</pre>";
echo "<hr>";
