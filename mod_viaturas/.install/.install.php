...
if(isset($_GET['instalar'])){
    ...
    $db=ligarBD();
    $sql="insert into modulos (nome_modulo,url,icon,nomeTabela,nomeColuna,id_parent,descricao,mostrar,principal,id_criou,created_at) values ('Viaturas','mod_viaturas','fa-truck','viaturas','viaturas','0','','1','0','1','2022-08-25 18:25:18')";
