...
if(isset($_GET['instalar'])){
    ...
    $db=ligarBD();
    $sql="insert into modulos (nome_modulo,url,icon,nomeTabela,nomeColuna,id_parent,descricao,mostrar,principal,id_criou,created_at) values ('IMAP','mod_imap','fa-envelope','imap','imap','0','','1','0','1','2022-04-24 01:37:31')";
