...
if(isset($_GET['instalar'])){
    ...
    $db=ligarBD();
    $sql="insert into modulos (nome_modulo,url,icon,nomeTabela,nomeColuna,id_parent,descricao,mostrar,principal,id_criou,created_at) values ('Notas','mod_notas','fa-sticky-note','srv_clientes_notas','nota','0','','0','0','1','2021-11-20 19:43:37')";
