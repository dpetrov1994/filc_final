...
if(isset($_GET['instalar'])){
    ...
    $db=ligarBD();
    $sql="insert into modulos (nome_modulo,url,icon,nomeTabela,nomeColuna,id_parent,descricao,mostrar,principal,id_criou,created_at) values ('Relatorios Avançado.','mod_relatorios_avancados','fa-file-text-o','relatorios_avancados','relatorio','276','','1','0','1','2022-08-12 13:19:00')";
...
(id_modulo, so_em_reciclagem, icon, nome_funcionalidade, nome_em_reciclagem, descricao, url, principal, mostrar, confirmar, multiplos, mostrarDropdown, mostrar_subMenu, id_criou, created_at, ativo) 
values 
($id_modulo,'0','fa-trash-o','Reciclar','Restaurar','Mover para a reciclagem.','reciclar.php','0','0','1','1','1','0','".$_SESSION['id_utilizador']."','".current_timestamp."','1')",
        "insert into modulos_funcionalidades 
(id_modulo, so_em_reciclagem, icon, nome_funcionalidade, nome_em_reciclagem, descricao, url, principal, mostrar, confirmar, multiplos, mostrarDropdown, mostrar_subMenu, id_criou, created_at, ativo) 
values 
