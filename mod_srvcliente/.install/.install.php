...
if(isset($_GET['instalar'])){
    ...
    $db=ligarBD();
    $sql="insert into modulos (nome_modulo,url,icon,nomeTabela,nomeColuna,id_parent,descricao,mostrar,principal,id_criou,created_at) values ('Clientes','mod_srvcliente','fa-users','srv_clientes','cliente','0','','1','0','1','2021-11-18 14:39:47')";
