...
if(isset($_GET['instalar'])){
    ...
    $db=ligarBD();
    $sql="insert into modulos (nome_modulo,url,icon,nomeTabela,nomeColuna,id_parent,descricao,mostrar,principal,id_criou,created_at) values ('Assistências e Máquinas','mod_assistencias_clientes_maquinas','fa-gear','assistencias_clientes_maquinas','assistencia_cliente_maquina','292','','1','0','1','2022-08-17 17:09:52')";
