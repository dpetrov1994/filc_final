...
if(isset($_GET['instalar'])){
    ...
    $db=ligarBD();
    $sql="insert into modulos (nome_modulo,url,icon,nomeTabela,nomeColuna,id_parent,descricao,mostrar,principal,id_criou,created_at) values ('Grupos','simulacoes_grupos','fa-users','simulacoes_grupos','grupo','231','','0','0','1','2020-10-22 12:44:30')";
